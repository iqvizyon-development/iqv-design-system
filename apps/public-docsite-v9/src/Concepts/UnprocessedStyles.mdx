...
Iqvizyon UI v9 components now ship with **raw module alternatives** to solve CSS style conflicts in multi-bundle applications. This feature addresses critical issues where Griffel-processed styles clash when multiple application bundles are loaded simultaneously.
...
| ----------------------------- | ---------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@iqvizyonui/react-components`  | ⚠️ Yes                 | ✅ Available          | [v9.67.0+](https://www.npmjs.com/package/@iqvizyonui/react-components/v/9.67.0)                                                                                                                                                                                                                                                 |
...
| `@iqvizyonui/react-charts`      | ⚠️ Yes                 | ✅ Available          | [v9.2.0+](https://www.npmjs.com/package/@iqvizyonui/react-charts/v/9.2.0)                                                                                                                                                                                                                                                       |
| `@fluentui/react-icons`       | ⚠️ Yes                 | ✅ Available          | [v2.0.307+](https://www.npmjs.com/package/@fluentui/react-icons/v/2.0.307)                                                                                                                                                                                                                                                    |
| `@iqvizyonui/react-brand-icons` | ⚠️ Yes                 | ✅ Available          | 2.0.197                                                                                                                                                                                                                                                                                                                       |
...
- 📖 [RFC: Stop pre-processing styles with Griffel](https://github.com/iBz-04/iqvui/blob/master/docs/react-v9/contributing/rfcs/shared/build-system/stop-styles-transforms.md)
