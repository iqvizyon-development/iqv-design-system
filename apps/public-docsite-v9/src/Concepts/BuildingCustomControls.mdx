...
Building one from scratch means reimplementing behavior that Iqvizyon UI has already solved. Base state hooks let you avoid that. They expose the behavior layer of a Fluent component as a standalone API you can call directly, while leaving rendering and styling entirely up to you.
...
For deeper rationale and design decisions, see the RFC: [Component Base State Hooks](https://github.com/iBz-04/iqvui/blob/master/docs/react-v9/contributing/rfcs/react-components/convergence/base-state-hooks.md).
