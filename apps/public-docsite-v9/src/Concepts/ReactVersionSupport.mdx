...
> ℹ️ **Note**: Our migration docs focus solely on IqvizyonUI related changes.
...
Full support starting `@iqvizyonui/react-components` v9.0.0.

## React 18

Full support starting `@iqvizyonui/react-components` v9.66.0.

### Migration

> 💡 Check Following PR for further details https://github.com/iBz-04/iqvui/pull/34456
...
```tsx
import * as React from 'React';
import { type SlotRenderFunction } from '@iqvizyonui/react-utilities';
...
Full support starting `@iqvizyonui/react-components` v9.72.2.
...
> 📚 **For Library Authors & IqvizyonUI Extension Developers**
>
> These recommendations ensure your library's TypeScript types remain backwards compatible across React 17, 18, and 19.
>
> 💡 [See PR #34733 for technical details](https://github.com/iBz-04/iqvui/pull/34733)
...
> 📖 [Learn more in PR #35080](https://github.com/iBz-04/iqvui/pull/35080)

##### 2. Use IqvizyonUI Cross-Version Compatible JSX Types

React's JSX namespace types changed between versions. IqvizyonUI provides stable, cross-compatible type utilities that work across React 17, 18, and 19.

**Setup ESLint Rule:**

Configure `@typescript-eslint/no-restricted-types` to enforce IqvizyonUI types. [View complete setup](https://github.com/iBz-04/iqvui/pull/34923/files#diff-76039af2f09c079049956d7b4b45efee6d01993677e1680519f5863fae6f0919)
...
✅ **After (IqvizyonUI cross-version types):**

```tsx
import type { JSXElement, JSXIntrinsicElementKeys, JSXIntrinsicElement } from '@iqvizyonui/react-components';
