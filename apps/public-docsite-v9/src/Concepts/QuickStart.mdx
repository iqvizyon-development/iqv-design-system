...
We are aware of some strict mode bugs when using Iqvizyon UI v9 in React 18. These bugs only show up in strict mode, and they will not stop the rest of your app from running.
You can [track the bugs on Github](https://github.com/iBz-04/iqvui/issues?q=is%3Aopen+is%3Aissue+label%3A%22Area%3A+Strict+Mode%22+label%3A%22React+18%22) and learn how they will affect your application.
