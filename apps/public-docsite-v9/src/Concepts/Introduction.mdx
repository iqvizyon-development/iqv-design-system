...
import pkg from '@iqvizyonui/react-components/package.json';
...
Iqvizyon UI React Components is a set of modern, accessible React UI components built on the Fluent Design System.
...
Reach out to the Iqvizyon UI React team on [GitHub](https://github.com/iBz-04/iqvui)
