...
const turkishTranslations = {
  ...
  'Components/Dropdown': {
    description: 'Açılır Liste (Dropdown), kullanıcının bir listeden bir veya daha fazla seçeneği seçmesini sağlayan bir bileşendir.',
  ...
  'Components/Button/ToggleButton': {
    description: 'İki Durumlu Buton (ToggleButton), bir durumun açık veya kapalı olduğunu belirtmek için kullanılan basılabilir bir butondur.',
  ...
  'Components/Carousel/Carousel': {
    description: 'Atlıkarınca (Carousel), birden fazla içerik veya görselin yatay bir şerit halinde kaydırılarak gösterilmesini sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Kullanıcının slaytlar arasında kolayca geçiş yapabilmesi için net yönlendirme okları ve gezinti noktaları sunun.'
  },
  'Components/SpinButton': {
    description: 'Değer Döndürme Butonu (SpinButton), kullanıcının artırma ve azaltma butonlarını kullanarak sayısal bir değeri değiştirmesini sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Sınırlı ve belirli bir aralıktaki sayısal değerlerin hızlıca girilmesi için idealdir.'
  },
  'Components/SwatchPicker': {
    description: 'Renk Paleti Seçici (SwatchPicker), kullanıcının önceden tanımlanmış renk kutucukları arasından seçim yapmasını sağlar.',
  ...
  'Components/Badge/PresenceBadge': {
    description: 'Durum Rozeti (PresenceBadge), bir kullanıcının çevrimiçi, meşgul, dışarıda veya çevrimdışı gibi anlık durumunu gösterir.',
  ...
  'Components/RadioGroup': {
    description: 'Radyo Grubu (RadioGroup), kullanıcının birbirini dışlayan bir dizi seçenek arasından yalnızca birini seçmesine olanak tanır.',
    bestPractices: '## En İyi Pratikler\n\n- Seçeneklerin tamamının ekranda görünür olması gerektiğinde ve seçenek sayısı az olduğunda tercih edin.'
  },
  'Components/Rating': {
    description: 'Derecelendirme (Rating), kullanıcının bir içerik veya hizmet hakkında yıldızlar aracılığıyla geri bildirim vermesini sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Genellikle 5 yıldızlı bir ölçek kullanılır. Yarım yıldız desteği sunarak daha hassas derecelendirme sağlayabilirsiniz.'
  },
  'Components/Menu/Menu': {
    description: 'Menü (Menu), bir butona tıklandığında açılan ve kullanıcının seçebileceği eylemleri veya seçenekleri içeren bir listedir.',
    bestPractices: '## En İyi Pratikler\n\n- İlgili eylemleri gruplandırmak ve ekran alanından tasarruf etmek için kullanın.'
  },
  'Components/Combobox': {
    description: 'Birleşik Giriş Kutusu (Combobox), kullanıcının metin yazarak arama yapabileceği ve listeden seçim yapabileceği gelişmiş bir açılır listedir.',
    bestPractices: '## En İyi Pratikler\n\n- Seçenek sayısının çok fazla olduğu ve kullanıcının arama yaparak seçeneğe ulaşması gerektiği durumlarda tercih edin.'
  },
  'Components/Field': {
    description: 'Alan (Field), bir giriş bileşenini, etiketini, açıklamasını ve hata mesajını bir arada sunan yapısal bir bileşendir.',
  ...
  'Components/Badge/Badge': {
    description: 'Rozet (Badge), bir öğenin üzerindeki bildirim sayısını, durumunu veya kısa bir bilgiyi göstermek için kullanılır.',
  ...
  'Components/Checkbox': {
    description: 'Onay Kutusu (Checkbox), kullanıcının bir listeden bağımsız bir veya daha fazla seçeneği seçmesini sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Seçeneklerin birbirinden bağımsız olduğu durumlarda kullanın.'
  },
  'Components/Spinner': {
    description: 'Yükleme Göstergesi (Spinner), bir işlemin devam ettiğini ve kullanıcının beklemesi gerektiğini belirten döner bir animasyondur.',
    bestPractices: '## En İyi Pratikler\n\n- Ekran okuyucular için `aria-live="polite"` ve uygun bir yükleme etiketi ekleyin.'
  },
  'Components/IqvizyonProvider': {
    description: 'Iqvizyon Sağlayıcı (IqvizyonProvider), uygulamanın tema, dil ve stil ayarlarını alt bileşenlere aktaran kök bileşendir.',
  ...
  'Components/Button/CompoundButton': {
    description: 'Bileşik Buton (CompoundButton), ana başlığın altında ek bir açıklama metni barındıran gelişmiş bir butondur.',
    bestPractices: '## En İyi Pratikler\n\n- Butonun ne işe yaradığına dair daha fazla bağlam sunmak istediğinizde tercih edin.'
  },
  'Components/TabList': {
    description: 'Sekme Listesi (TabList), kullanıcının farklı içerik görünümleri arasında geçiş yapmasını sağlayan bir sekme grubudur.',
  ...
  'Components/Badge/Counter Badge': {
    description: 'Sayaç Rozeti (Counter Badge), okunmamış mesaj sayısı gibi sayısal bildirimleri göstermek için kullanılan bir rozettir.',
    bestPractices: '## En İyi Pratikler\n\n- Sayısal değerlerin net ve okunabilir şekilde gösterilmesi için dairesel formda tasarlanmıştır.'
  },
  'Components/Popover': {
    description: 'Açılır Pencere (Popover), bir öğeye tıklandığında o öğenin yakınında açılan ve zengin içerik barındırabilen bir paneldir.',
    bestPractices: '## En İyi Pratikler\n\n- Basit ipuçlarından daha karmaşık formlar veya etkileşimli içerikler sunmak için idealdir.'
  },
  'Components/Overflow': {
    description: 'Taşma (Overflow), ekrana sığmayan bileşenlerin otomatik olarak bir "Daha Fazla" menüsü altında toplanmasını sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Duyarlı (responsive) tasarımlarda menü ve araç çubuklarının taşmasını önlemek için kullanın.'
  },
  'Components/AvatarGroup': {
    description: 'Profil Resmi Grubu (AvatarGroup), birden fazla kullanıcının profil resmini yan yana veya üst üste yığılmış şekilde gösterir.',
  ...
  'Components/Card/CardPreview': {
    description: 'Kart Önizlemesi (CardPreview), kart bileşeninin içinde görsel veya video gibi medya içeriklerini barındıran bölümdür.',
  ...
  'Components/Carousel/CarouselNav': {
    description: 'Atlıkarınca Gezinmesi (CarouselNav), atlıkarınca içindeki slaytlar arasında geçiş yapmayı sağlayan butonlar ve göstergelerdir.',
    bestPractices: '## En İyi Pratikler\n\n- Slayt geçişlerinin kullanıcı tarafından kolayca kontrol edilebilmesi için görünür kılın.'
  },
  'Components/Card/CardHeader': {
    description: 'Kart Başlığı (CardHeader), kart bileşeninin en üstünde yer alan başlık, alt başlık ve avatar gibi bilgileri barındıran bölümdür.',
    bestPractices: '## En İyi Pratikler\n\n- Kartın içeriğini hızlıca özetlemek ve başlık hiyerarşisi oluşturmak için kullanın.'
  },
  'Components/Drawer': {
    description: 'Çekmece (Drawer), ekranın kenarından kayarak açılan ve ek içerik veya gezinti menüleri barındıran bir paneldir.',
    bestPractices: '## En İyi Pratikler\n\n- Ekran alanını korumak ve ikincil işlemleri veya filtreleri barındırmak için kullanın.'
  },
  'Components/Text': {
    description: 'Metin (Text), tasarım sistemindeki tipografi standartlarına uygun olarak biçimlendirilmiş metinler oluşturmayı sağlar.',
    bestPractices: '## En İyi Pratikler\n\n- Başlıklar, paragraflar ve açıklamalar için tasarım belirteçlerine (tokens) uygun yazı tiplerini kullanın.'
  },
  'Components/Input': {
    description: 'Giriş (Input), kullanıcının tek satırlı metin veya sayısal veri girmesini sağlayan temel form alanıdır.',
    bestPractices: '## En İyi Pratikler\n\n- Her giriş alanının her zaman net ve açıklayıcı bir etiketi (Label) olmalıdır.'
  },
  'Components/Portal/toMountNodeProps': {
    description: 'Bağlama Düğümü Özellikleri (toMountNodeProps), portalların DOM üzerinde hangi düğüme bağlanacağını yapılandırmak için kullanılır.',
  ...
  'Components/Persona': {
    description: 'Kişi Kartı (Persona), bir kişinin profil resmi, adı, unvanı ve çevrimiçi durumu gibi bilgilerini bir arada gösterir.',
  ...
  'Components/MessageBar': {
    description: 'Mesaj Çubuğu (MessageBar), kullanıcılara bilgi, başarı, uyarı veya hata mesajlarını ileten yatay bir bildirim alanıdır.',
    bestPractices: '## En İyi Pratikler\n\n- Kritik olmayan sistem bildirimleri veya form işlem sonuçlarını göstermek için idealdir.'
  },
  'Components/Skeleton': {
    description: 'İskelet Yükleme Ekranı (Skeleton), içerik yüklenirken sayfa düzeninin taslağını göstererek yükleme hissini iyileştiren bir bileşendir.',
  ...
  'Components/Button/MenuButton': {
    description: 'Menü Butonu (MenuButton), tıklandığında bir menü açan ve yanında bir aşağı ok ikonu barındıran butondur.',
  ...
  'Components/Tag/Tag': {
    description: 'Etiket (Tag), bir öğeyi kategorize etmek, filtrelemek veya etiketlemek için kullanılan küçük, etkileşimli bir görsel öğedir.',
  ...
  'Components/RatingDisplay': {
    description: 'Derecelendirme Gösterimi (RatingDisplay), bir içeriğin derecelendirme puanını salt okunur olarak yıldızlar ve sayılarla gösterir.',
  ...
  'Components/TeachingPopover': {
    description: 'Eğitici Açılır Pencere (TeachingPopover), kullanıcılara yeni özellikleri tanıtmak veya arayüzü öğretmek için kullanılan rehber paneldir.',
  ...
  'Components/SearchBox': {
    description: 'Arama Kutusu (SearchBox), kullanıcının bir liste veya sayfa içinde arama yapmasını sağlayan, içinde arama ikonu ve temizleme butonu barındıran alandır.',
  ...
  'Components/Tag/TagGroup': {
    description: 'Etiket Grubu (TagGroup), birden fazla etiket bileşenini bir arada düzenli bir şekilde sunan ve yöneten konteynerdir.',
  ...
  'Components/DataGrid': {
    description: 'Veri Izgarası (DataGrid), büyük miktardaki verileri sıralama, filtreleme ve seçme özellikleriyle birlikte sunan gelişmiş bir tablodur.',
    bestPractices: '## En İyi Pratikler\n\n- Performans için büyük veri setlerinde sanallaştırma (virtualization) veya sayfalama (pagination) kullanın.'
  },
  'Components/Tooltip': {
    description: 'İpucu (Tooltip), bir öğenin üzerine gelindiğinde veya odaklanıldığında kısa ve açıklayıcı bilgi sunan küçük kutucuktur.',
    bestPractices: '## En İyi Pratikler\n\n- Sadece ek ve yardımcı bilgiler için kullanın; kritik bilgileri tooltip içine gizlemeyin.'
  },
  'Components/Toolbar': {
    description: 'Araç Çubuğu (Toolbar), sık kullanılan eylemleri ve butonları yatay bir şerit halinde bir arada sunan bileşendir.',
    bestPractices: '## En İyi Pratikler\n\n- İlgili araçları gruplara ayırarak ve aralarına bölücüler ekleyerek görsel düzeni artırın.'
  },
  'Components/Breadcrumb': {
    description: 'Yol Haritası (Breadcrumb), kullanıcının site hiyerarşisi içindeki mevcut konumunu gösteren ve önceki sayfalara kolayca dönmesini sağlayan gezinti bağlantılarıdır.',
    bestPractices: '## En İyi Pratikler\n\n- Hiyerarşik yapısı derin olan web sitelerinde kullanıcı deneyimini ve yön bulmayı kolaylaştırmak için kullanın.'
  },
  'Components/Select': {
    description: 'Seçim Kutusu (Select), kullanıcının açılır bir listeden tek bir seçeneği seçmesini sağlayan standart form bileşenidir.',
    bestPractices: '## En İyi Pratikler\n\n- Seçenek sayısının az ve sabit olduğu durumlarda yerel tarayıcı desteğiyle birlikte kullanın.'
  },
  'Components/Tag/InteractionTag': {
    description: 'Etkileşimli Etiket (InteractionTag), tıklandığında veya kapatıldığında bir eylemi tetikleyebilen özel bir etiket türüdür.',
    bestPractices: '## En İyi Pratikler\n\n- Seçilen filtreleri iptal etmek veya dinamik etiket listeleri oluşturmak için idealdir.'
  },
  'Components/Link': {
    description: 'Bağlantı (Link), kullanıcının başka bir sayfaya veya bölüme gitmesini sağlayan tıklanabilir metindir.',
    bestPractices: '## En İyi Pratikler\n\n- Sayfa içi eylemler için Buton, gezinme (navigasyon) için Bağlantı kullanın.'
  },
  'Components/ColorPicker': {
    description: 'Renk Seçici (ColorPicker), kullanıcının renk paleti veya renk değerleri girerek özel bir renk seçmesini sağlayan gelişmiş bileşendir.',
    bestPractices: '## En İyi Pratikler\n\n- Tasarım araçları veya özelleştirilebilir arayüz ayarlarında kullanıcılara geniş renk özgürlüğü sunmak için kullanın.'
  },
  'Components/Nav': {
    description: 'Gezinme (Nav), uygulamanın ana bölümleri arasında geçiş yapmayı sağlayan dikey veya yatay menü sistemidir.',
    bestPractices: '## En İyi Pratikler\n\n- Uygulama içi ana gezinti yapısını oluşturmak için sol kenar çubuğunda veya üst barda konumlandırın.'
  },
  'Components/Toast': {
    description: 'Anlık Bildirim (Toast), ekranın köşesinde geçici olarak beliren ve kullanıcıya işlem sonuçlarını ileten hafif bildirimlerdir.',
    bestPractices: '## En İyi Pratikler\n\n- Kullanıcının mevcut işini bölmeden, arka planda tamamlanan işlemler hakkında bilgi vermek için kullanın.'
  },
  'Components/Tree': {
    description: 'Ağaç Görünümü (Tree), hiyerarşik verileri (klasör yapıları gibi) genişletilebilir ve daraltılabilir dallar halinde sunar.',
    bestPractices: '## En İyi Pratikler\n\n- Dosya sistemleri, organizasyon şemaları veya kategorize edilmiş derin hiyerarşiler için kullanın.'
  },
  'Components/Image': {
    description: 'Resim (Image), görsellerin duyarlı (responsive) ve performanslı bir şekilde yüklenmesini ve gösterilmesini sağlayan bileşendir.',
  ...
  'Components/Portal/Portal': {
    description: 'Portal (Portal), bir bileşenin DOM ağacında hiyerarşik olarak farklı bir yere (genellikle document.body altına) işlenmesini (render) sağlar.',
  ...
  'Components/ProgressBar': {
    description: 'İlerleme Çubuğu (ProgressBar), uzun süren bir işlemin tamamlanma yüzdesini görsel olarak gösteren çubuktur.',
  ...
  'Components/Accordion': {
    description: 'Akordeon (Accordion), dikey olarak üst üste yığılmış ve tıklandığında genişleyerek detaylı içerik gösteren bölümlerdir.',
  ...
  'Components/TagPicker': {
    description: 'Etiket Seçici (TagPicker), kullanıcının arama yaparak veya önerilen listeden birden fazla etiket seçmesini sağlayan form alanıdır.',
    bestPractices: '## En İyi Pratikler\n\n- Kullanıcılara çoklu kategori, ilgi alanı veya kişi etiketleme imkanı sunmak için kullanın.'
  },
  'Components/Menu/MenuList': {
    description: 'Menü Listesi (MenuList), menü bileşeninin içindeki seçeneklerin listelendiği ve yönetildiği dikey gruptur.',
    bestPractices: '## En İyi Pratikler\n\n- Menü öğelerini mantıksal gruplara ayırmak ve aralarına bölücüler eklemek için kullanın.'
  },
  'Components/Card/CardFooter': {
    description: 'Kart Alt Bilgisi (CardFooter), kart bileşeninin en altında yer alan ve eylem butonlarını barındıran bölümdür.',
  ...
  'Components/Button/SplitButton': {
    description: 'Bölünmüş Buton (SplitButton), sol tarafı ana bir eylemi tetikleyen, sağ tarafı ise ek seçenekler menüsünü açan iki parçalı butondur.',
  ...
  'Compat Components/DatePicker': {
    description: 'Tarih Seçici (DatePicker), uyumluluk sürümü olup eski Fluent UI v8 projelerinden geçişi kolaylaştırmak amacıyla tasarlanmıştır.',
    bestPractices: '## En İyi Pratikler\n\n- Yeni projelerde doğrudan modern React DatePicker bileşenini tercih edin.'
  },
  'Compat Components/TimePicker': {
    description: 'Saat Seçici (TimePicker), uyumluluk sürümü olup eski projelerden geçişi kolaylaştırmak amacıyla tasarlanmıştır.',
    bestPractices: '## En İyi Pratikler\n\n- Saat formatlarını kullanıcının yerel ayarlarına (24 saat veya AM/PM) uygun şekilde gösterin.'
  },
  'Compat Components/Calendar': {
    description: 'Takvim (Calendar), uyumluluk sürümü olup eski projelerden geçişi kolaylaştırmak amacıyla tasarlanmıştır.',
