...
> ℹ️ **Note**: Our migration docs focus solely on Iqvizyon UI related changes.
...
> 📚 **For Library Authors & Iqvizyon UI Extension Developers**
>
...
##### 2. Use Iqvizyon UI Cross-Version Compatible JSX Types
...
Configure `@typescript-eslint/no-restricted-types` to enforce Iqvizyon UI types. See the `@iqvizyonui/react-utilities` JSX type exports for the recommended replacements.
...
✅ **After (Iqvizyon UI cross-version types):**
