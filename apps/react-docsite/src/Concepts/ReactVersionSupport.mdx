...
Configure `@typescript-eslint/no-restricted-types` to enforce IqvizyonUI types. [View complete setup](https://github.com/microsoft/fluentui/pull/34923/files#diff-76039af2f09c079049956d7b4b45efee6d01993677e1680519f5863fae6f0919)
