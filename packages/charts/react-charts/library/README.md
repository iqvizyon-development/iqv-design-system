...
**React Charts components for [Iqvizyon UI React](https://iqvizyon-development.github.io/iqv-design-system/react/)**
...
Examples and code snippets for the chart components are available on the [doc site](https://iqvizyon-development.github.io/iqv-design-system/charts/).
...
You can reach out via [GitHub discussions](https://github.com/iqvizyon-development/iqv-design-system/discussions).

You could also create issues using the [charting](https://github.com/iqvizyon-development/iqv-design-system/issues/new?template=03-react-charting-bug-report.yml) template.

## Contributing

[![contributions welcome](https://img.shields.io/badge/contributions-welcome-1EAEDB)]()

Refer to the [Iqvizyon UI wiki](https://github.com/iqvizyon-development/iqv-design-system/wiki) for detailed instructions on setup and contributing to the package.

## Resources

- [Chart doc site](https://iqvizyon-development.github.io/iqv-design-system/charts/) for examples and API reference
- [Iqvizyon UI wiki](https://github.com/iqvizyon-development/iqv-design-system/wiki) for contributor and technical guides
- [GitHub discussions](https://github.com/iqvizyon-development/iqv-design-system/discussions) for questions and feedback
...
See accessibility examples on the [chart doc site](https://iqvizyon-development.github.io/iqv-design-system/charts/).
