...
export const HeatMapDateStringData: HeatMapChartProps['data'] = [
  {
    value: 100,
...
const HeatMapStringData: HeatMapChartProps['data'] = [
  {
    value: 100,
    legend: 'Excellent',
    data: [
...
const HeatMapNumberData: HeatMapChartProps['data'] = [
  {
    value: 100,
    legend: 'Excellent',
    data: [
...
describe('Heat Map Chart - Subcomponent Legend', () => {
  ...
  test('Should highlight legend on mouse over on legends', async () => {
    ...
    const legendsAfterMouseEvent = screen.getAllByText(
      (content, element) => element!.tagName.toLowerCase() === 'button',
    );
    // Assert
    expect(legendsAfterMouseEvent[0]).toHaveAttribute('style', prevStyles0);
    expect(legendsAfterMouseEvent[1]).not.toHaveAttribute('style', prevStyles1);
  });
  ...
  test('Should reset legend on mouse leave from legends', async () => {
    ...
    // Assert
    expect(legendsAfterMouseEvent[0]).toHaveAttribute('style', prevStyles0);
    expect(legendsAfterMouseEvent[1]).toHaveAttribute('style', prevStyles1);
  });
...
describe('Render calling with respective to props', () => {
  ...
  it('No prop changes', () => {
    ...
    const { rerender, container } = render(<HeatMapChart {...props} />);
  ...
  it('prop changes', () => {
    ...
    const { rerender, container } = render(<HeatMapChart {...props} />);
    const htmlBefore = container.innerHTML;
    rerender(<HeatMapChart {...props} hideLegend={false} />);
    const htmlAfter = container.innerHTML;
