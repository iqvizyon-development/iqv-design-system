  ...
  docs: {
    description: {
      story:
        ...
        `To manually control the maxHeight of the listbox, refer to the [positioning autoSize property](https://iqvizyon-development.github.io/iqv-design-system/react/?path=/docs/concepts-developer-positioning-components--docs#auto-size-for-small-viewport)`,
    },
  },
};
