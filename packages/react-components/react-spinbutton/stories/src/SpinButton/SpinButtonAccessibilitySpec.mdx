...
Verify that the spin button arrows remain visible in high contrast mode.
...
Authors must provide a label for SpinButton. The recommended pattern for Iqvizyon inputs is to use the Label component like this:
