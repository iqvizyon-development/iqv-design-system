...
/**
 * Collects all relative import declarations starting with '.' and all @iqvizyonui/ scoped imports
 * Replaces all import declarations with one single import declartion from @iqvizyonui/react-components
 *
