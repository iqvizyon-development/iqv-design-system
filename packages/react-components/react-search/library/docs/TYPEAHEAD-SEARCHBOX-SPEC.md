...
- [Iqvizyon UI design docs for SearchBox](https://ibz-04.github.io/iqvui/react/?path=/docs/components-searchbox--docs) — guidance on sorting results; rendering is left to the developer.
