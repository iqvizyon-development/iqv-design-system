...
The Iqvizyon Motion System uses **design tokens** — named values that keep animation timing consistent across Iqvizyon products. Instead of picking arbitrary millisecond values, you choose a token that communicates the _intent_ of the motion.
