...
- `onMotionStart`, `onMotionFinish`, `onMotionCancel` — lifecycle callbacks, each receiving `{ direction: 'enter' | 'exit' }`. See [CreatePresenceComponent › LifecycleCallbacks](https://iqvizyon-development.github.io/iqv-design-system/react/?path=/docs/motion-apis-createpresencecomponent-lifecyclecallbacks--docs).

For details on creating the underlying animations, see the [createPresenceComponent](https://iqvizyon-development.github.io/iqv-design-system/react/?path=/docs/motion-apis-createpresencecomponent--docs) documentation.
