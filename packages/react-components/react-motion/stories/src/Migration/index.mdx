...
<div className="migration-hero">
  ...
  <p>
    Coming from another animation library? This guide helps you understand how Iqvizyon Motion compares and how to
    migrate.
  </p>
</div>
...
Iqvizyon Motion is purpose-built for Microsoft's design system with specific goals:
...
<div className="pro-con-grid">
  <div className="pro-box">
    ...
    <ul>
      ...
      <li>Design token integration — Iqvizyon durations & curves</li>
...
Framer Motion is a popular choice for React animations. Here's how common patterns translate to Iqvizyon Motion.
...
import { fadeAtom, scaleAtom } from '@iqvizyonui/react-motion-components-preview';
...
```tsx
import { Stagger, Fade } from '@iqvizyonui/react-motion-components-preview';
...
| Framer Motion Feature | Iqvizyon Motion Alternative                            |
| --------------------- | ---------------------------------------------------- |
...
React Spring focuses on spring physics. Iqvizyon Motion uses keyframe-based animations instead.
...
- **No spring physics**: Iqvizyon Motion uses CSS easing curves. For a spring-like feel, use `curveDecelerateMid` or `curveDecelerateMax`.
...
GSAP is a powerful timeline-based animation library. Iqvizyon Motion is simpler but covers most UI animation needs.
...
### What GSAP Does That Iqvizyon Motion Doesn't
...
For these advanced use cases, GSAP may still be the right choice. Iqvizyon Motion is optimized for common UI transitions.
...
| Concept            | Framer Motion               | React Spring      | GSAP             | Iqvizyon Motion                                    |
| ------------------ | --------------------------- | ----------------- | ---------------- | ------------------------------------------------ |
...
| ------------------------------------- | ----------------- |
| Iqvizyon UI app, simple transitions     | **Iqvizyon Motion** |
| Complex gesture interactions          | Framer Motion     |
| Spring physics feel                   | React Spring      |
| Complex timelines, scroll-driven      | GSAP              |
| Performance-critical, minimal bundle  | **Iqvizyon Motion** |
| Design system consistency (Microsoft) | **Iqvizyon Motion** |
