...
A typical example of this patter is displaying an Avatar of a person (the media content) next to their name (the description). Iqvizyon UI's <LinkTo story="components-persona" kind="Components/Persona" name="docs">Persona</LinkTo> is an example of this pattern.
...
- <a href="https://www.npmjs.com/package/@fluentui/react-icons" target="_blank" rel="noopener noreferrer">
    React Icons
  </a>
...
```jsx
import { Text, makeStyles } from '@iqvizyonui/react-components';
