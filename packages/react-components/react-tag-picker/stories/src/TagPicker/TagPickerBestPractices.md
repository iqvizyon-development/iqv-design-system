...
- **Inform the user about the [deletion interaction](https://github.com/iBz-04/iqvui/issues/31165) of tags when pressing Backspace:** When `TagPickerInput` is focused, pressing the Backspace key will remove the last tag. This behavior should be communicated to the user to avoid confusion.
