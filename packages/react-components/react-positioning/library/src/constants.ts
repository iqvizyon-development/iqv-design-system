...
export const POSITIONING_END_EVENT = 'iui-positioningend';
 ...
 */
export const POSITIONING_SLIDE_DIRECTION_VAR_X = '--iui-positioning-slide-direction-x';
export const POSITIONING_SLIDE_DIRECTION_VAR_Y = '--iui-positioning-slide-direction-y';
