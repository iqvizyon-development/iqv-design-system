...
The \`actions\` slot has a \`role="toolbar"\` and ensures proper horizontal navigation with the keyboard by using [\`useArrowNavigationGroup\`](https://ibz-04.github.io/iqvui/react/?path=/docs/utilities-focus-management-usearrownavigationgroup--default).
