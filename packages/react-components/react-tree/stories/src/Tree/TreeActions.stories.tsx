...
The \`actions\` slot has a \`role="toolbar"\` and ensures proper horizontal navigation with the keyboard by using [\`useArrowNavigationGroup\`](https://iqvizyon-development.github.io/iqv-design-system/react/?path=/docs/utilities-focus-management-usearrownavigationgroup--default).
