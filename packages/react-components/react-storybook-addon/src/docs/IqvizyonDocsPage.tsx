...
export const IqvizyonDocsPage = ({
  ...
  const themes: Theme[] =
    primaryStoryContext.parameters?.iqvizyonThemes ?? primaryStoryContext.globals?.[THEMES] ?? defaultThemes;
  ...
  // DEBUG
  // console.log('IqvizyonDocsPage', context);
