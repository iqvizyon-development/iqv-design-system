  ...
  const dynamicPresets = [
    [
      '@griffel',
      {
         ...
         * "By default, preset handles imports from @griffel/react & @iqvizyonui/react-components" - under the hood griffel preset wont merge rather override thus we need to provide the default modules explicitly
         */
        modules: [
          // Why is core needed ?
          // - https://github.com/iqvizyon-development/iqv-design-system/blob/8d4bd6428dc2f52948e668f1f1410972b6c5cf62/packages/react-components/react-provider/src/components/IqvizyonProvider/useIqvizyonProviderStyles.styles.ts#L1
